    ...
    <header style={styles.navbar_container}>
      <div style={{paddingBottom: 15, alignItems: "center", display: "flex"}}>
        ...
        <div style={{display: "flex"}}>
          <div style={styles.nav_button} onClick={() => {window.location.href = "/dashboard"}}>
          ...
          <div style={styles.nav_button} onClick={() => {window.location.href = "/secret"}}>
            <p style={styles.navbar_text}>Secret</p>
          </div>
        </div>
      </div>
