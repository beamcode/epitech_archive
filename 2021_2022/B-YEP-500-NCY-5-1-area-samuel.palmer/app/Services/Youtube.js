...
const YoutubeButton = (props) => {
    ...
    return (
        <View style={{flexDirection: 'row', marginBottom: 20}}>
            <TouchableOpacity style={{backgroundColor: '#D10909', width: '70%', alignSelf: 'center', height: 40, borderRadius: 10, left: 50}}
                onPress={() => Pressed()}>
                 <Text style={{fontSize: 14, color: 'white', alignSelf: 'center', top: 10}}> Connect to Youtube</Text>
            </TouchableOpacity>
